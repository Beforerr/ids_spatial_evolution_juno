...
Because the discontinuities may have different spatial scale at different radial distances from the Sun, we repeat the search procedure with time lags $τ = 10, 20, 30, 40, 50, 60$ s, and combine the identified ID events together to establish the event list.
