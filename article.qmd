...
Juno orbit, its longitudinal difference with Earth & STEREO missions, sunspot number during its cruise phase and near-Earth’s and STEREO-A solar wind plasma data during JUNO cruise phase
...
::: {#fig-rate}
![](figures/ocr/ocr_time_cleaned){width=45%}
