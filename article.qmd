...
<!-- ![](figures/juno_orbit_white){#fig-orbit width=85%} -->

<!-- ![](figures/juno-hg-loc_sunspot-number){#fig-hg-loc-sunspot} -->
...
> To cover IDs at different spatial scales, we repeat the search procedure with time lags T = 10, 20, 30, 40, 50, 60s, and combine the identiﬁed ID events together to establish the event list.
