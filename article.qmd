...
Here, $α$ and $θ$ represent the shape and scale parameters, respectively. The complementary cumulative distribution function of the Weibull distribution $F(τ; α, θ) = 1 - \mathrm{e}^{-(τ/θ)^α}$ is a stretched exponential function.
