---
title: Solar wind discontinuities spatial evolution
author:
  - name: Zijin Zhang
...
'Discontinuities' are discontinuous spatial changes in plasma parameters/characteristics and magnetic fields [@colburnDiscontinuitiesSolarWind1966].

They are observed across the heliosphere from inner heliosphere [@liuCategorizingMHDDiscontinuities2022] to the heliosheath [@burlagaCurrentSheetsHeliosheath2011].
...
-   Contribution of Strong Discontinuities to the Power Spectrum
    ...
    > The strong discontinuities produce a power-law spectrum in the 'inertial subrange' with a spectral index near the Kolmogorov -5/3 index. The discontinuity spectrum contains about half of the power of the full solar-wind magnetic ﬁeld over this 'inertial subrange'. [@borovskyContributionStrongDiscontinuities2010]
...
![](figures/examples/artemis_id_example.png)

![](figures/examples/stereo_id_example.png)

Examples of IDs from ARTEMIS, STEREO, and JUNO

:::

<!-- ![Near-Earth' solar wind plasma data during JUNO cruise phase](figures/omni_overview){#fig-omni_overview} -->
