...
For model validation part, please see [JUNO Model Report](notebooks/analysis/20_model.ipynb).

## Results

For all results, see [results page](notebooks/results.qmd).

### Occurrence rates

[For code, see [noteboook](notebooks/analysis/01_occurence_rate.ipynb).]{.aside}
...
![Model validation](figures/model/juno_model_validation_full){#fig-model_validation}

![Effect of the time resolution on the discontinuity properties](figures/ts_effect){#fig-ts_effect}